...
#
left_weight_list=[]
letf_weight = delta[-1][0][:layer[-1]]
print('letf_weight')
print(letf_weight)
left_weight_list.append(letf_weight)
down_weight = delta[-1][0][layer[-1]:]
print('down_weight')
print(down_weight)



for i in range(3,len(weight_middle)):
    print()
    print('weight_middle[-i]')
    print(weight_middle[-i])
    print()
    delta.append(np.dot(down_weight, weight_middle[-i]))
    print(layer[-i+1])
    print(layer[-i])
    print(delta[-1])

    letf_weight = delta[-1][:layer[-i+1]]
    print('letf_weight')
    print(letf_weight)
    down_weight = delta[-1][layer[-i+1]:]
    print('down_weight')
    print(down_weight)
    # pass
...
#
#
# delta.append(np.dot(down_weight,weight_middle[-4]))
# print(layer[-3])
# print(layer[-4])
# print(delta[-1])
#
# letf_weight = delta[-1][:layer[-3]]
# print('letf_weight')
# print(letf_weight)
# down_weight = delta[-1][layer[-3]:]
# print('down_weight')
# print(down_weight)
#
# delta.append(np.dot(down_weight,weight_middle[-5]))
# print(layer[-4])
# print(layer[-5])
# print(delta[-1])
#
# letf_weight = delta[-1][:layer[-4]]
# print('letf_weight')
# print(letf_weight)
# down_weight = delta[-1][layer[-4]:]
# print('down_weight')
# print(down_weight)
#
...
#最后一次
delta.append(np.dot(down_weight,weight_middle[0]))
print(layer[0])
print(input_len)
print(delta[-1])

letf_weight = delta[-1][:layer[0]]
print('letf_weight')
print(letf_weight)
down_weight = delta[-1][layer[0]:]
print('down_weight')
print(down_weight)

#至此，drnn反向传播第一段梯度传递完成
# 接下来进行第二段及之后梯度传递
# 实现后对权重进行更行
